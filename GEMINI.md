...
- One query into one sheet and/or file
- One query multiple sheets and/or files
- Multiple queries into one sheet and/or file
- Multiple queries into multiple sheets and/or files
...
- Use the Github action workflows to run the tests after every commint on every branch.
